...
Work code-review comments left in a running difit (cli, available in PATH) session. One invocation runs one pass; the user re-invokes to resume discussions and pick up new comments.
